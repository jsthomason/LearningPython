...
*AlertsApi* | [**update_alert1**](docs/AlertsApi.md#update_alert1) | **PUT** /api/v2/alerts/{id} | Update alert
...
*AuthenticationApi* | [**sign_in1**](docs/AuthenticationApi.md#sign_in1) | **POST** /api/v2/authentication/signin | Sign in user
...
*DeviceGroupsApi* | [**delete_device_group_by_id1**](docs/DeviceGroupsApi.md#delete_device_group_by_id1) | **DELETE** /api/v2/devicegroups/{id} | Delete device group
...
*DeviceTypesApi* | [**get_device_type_for_device_by_id1**](docs/DeviceTypesApi.md#get_device_type_for_device_by_id1) | **GET** /api/v2/devicetypes/members/{deviceId} | Get device types for device
...
*DynamicPluginApi* | [**register_dynamic_plugin_manager**](docs/DynamicPluginApi.md#register_dynamic_plugin_manager) | **POST** /api/v1/pluginmanager/register | Register dynamic plugin manager
...
*ObjectsApi* | [**update_object_by_id**](docs/ObjectsApi.md#update_object_by_id) | **PUT** /api/v1/devices/{deviceId}/objects/{id} | Update object
...
*PluginsApi* | [**filter_plugin_indicator_types1**](docs/PluginsApi.md#filter_plugin_indicator_types1) | **POST** /api/v2/plugins/indicatortypes/filter | Find plugin indicator types
...
*ReportAttachmentsApi* | [**delete_report_attachment1**](docs/ReportAttachmentsApi.md#delete_report_attachment1) | **DELETE** /api/v2/reports/attachments/{id} | Delete report attachment
...
*ReportAttachmentsAlertsApi* | [**get_alert_attachment_time_settings1**](docs/ReportAttachmentsAlertsApi.md#get_alert_attachment_time_settings1) | **GET** /api/v2/reports/attachments/alerts/{id}/time | Get alert attachment time settings
...
*ReportAttachmentsDevicesApi* | [**update_device_attachment1**](docs/ReportAttachmentsDevicesApi.md#update_device_attachment1) | **PUT** /api/v2/reports/attachments/devices/{id}/resources | Update devices report attachment
...
*ReportAttachmentsGroupMetricsApi* | [**get_group_metrics_attachment_settings**](docs/ReportAttachmentsGroupMetricsApi.md#get_group_metrics_attachment_settings) | **GET** /api/v1/reports/attachments/group-metrics/{id}/settings | Get group metrics report attachment
...
*ReportAttachmentsMetadataApi* | [**partially_update_metadata_attachment_visualization_settings**](docs/ReportAttachmentsMetadataApi.md#partially_update_metadata_attachment_visualization_settings) | **PATCH** /api/v1/reports/attachments/metadata/{id}/visualizations | Partially update visualization settings
...
*ReportAttachmentsObjectsApi* | [**create_object_attachment**](docs/ReportAttachmentsObjectsApi.md#create_object_attachment) | **POST** /api/v1/reports/{id}/attachments/objects | Create objects attachment
...
*ReportAttachmentsObjectsApi* | [**update_object_attachment_settings1**](docs/ReportAttachmentsObjectsApi.md#update_object_attachment_settings1) | **PUT** /api/v2/reports/attachments/objects/{id}/settings | Update attachment settings
*ReportAttachmentsObjectsApi* | [**update_object_attachment_visualization_settings**](docs/ReportAttachmentsObjectsApi.md#update_object_attachment_visualization_settings) | **PUT** /api/v1/reports/attachments/objects/{id}/visualizations | Update visualization settings
*ReportAttachmentsObjectsApi* | [**update_object_attachment_visualization_settings1**](docs/ReportAttachmentsObjectsApi.md#update_object_attachment_visualization_settings1) | **PUT** /api/v2/reports/attachments/objects/{id}/visualizations | Update visualization settings
...
*ReportAttachmentsStatusMapApi* | [**create_status_map_attachment**](docs/ReportAttachmentsStatusMapApi.md#create_status_map_attachment) | **POST** /api/v1/reports/{id}/attachments/statusmap | Create statusmap attachment
*ReportAttachmentsStatusMapApi* | [**create_status_map_attachment1**](docs/ReportAttachmentsStatusMapApi.md#create_status_map_attachment1) | **POST** /api/v2/reports/{id}/attachments/statusmap | Create statusmap attachment
...
*ReportAttachmentsStatusMapApi* | [**get_status_map_attachment_resources**](docs/ReportAttachmentsStatusMapApi.md#get_status_map_attachment_resources) | **GET** /api/v1/reports/attachments/statusmap/{id}/resources | Get resources
*ReportAttachmentsStatusMapApi* | [**get_status_map_attachment_resources1**](docs/ReportAttachmentsStatusMapApi.md#get_status_map_attachment_resources1) | **GET** /api/v2/reports/attachments/statusmap/{id}/resources | Get resources
*ReportAttachmentsStatusMapApi* | [**update_status_map_attachment_resources**](docs/ReportAttachmentsStatusMapApi.md#update_status_map_attachment_resources) | **PUT** /api/v1/reports/attachments/statusmap/{id}/resources | Update resources
*ReportAttachmentsStatusMapApi* | [**update_status_map_attachment_resources1**](docs/ReportAttachmentsStatusMapApi.md#update_status_map_attachment_resources1) | **PUT** /api/v2/reports/attachments/statusmap/{id}/resources | Update resources
*ReportAttachmentsTelephonyApi* | [**create_telephony_attachment**](docs/ReportAttachmentsTelephonyApi.md#create_telephony_attachment) | **POST** /api/v2/reports/{id}/attachments/telephony | Create telephony report attachment
*ReportAttachmentsTelephonyApi* | [**create_telephony_attachment1**](docs/ReportAttachmentsTelephonyApi.md#create_telephony_attachment1) | **POST** /api/v1/reports/{id}/attachments/telephony | Create telephony report attachment
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment) | **GET** /api/v2/reports/attachments/telephony/{id} | Get telephony attachment
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment_aggregation**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment_aggregation) | **GET** /api/v2/reports/attachments/telephony/{id}/aggregation | Get attachment aggregation
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment_aggregation1**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment_aggregation1) | **GET** /api/v1/reports/attachments/telephony/{id}/aggregation | Get attachment aggregation
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment_settings**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment_settings) | **GET** /api/v2/reports/attachments/telephony/{id}/settings | Get attachment settings
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment_settings1**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment_settings1) | **GET** /api/v1/reports/attachments/telephony/{id}/settings | Get attachment settings
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment_time_settings**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment_time_settings) | **GET** /api/v2/reports/attachments/telephony/{id}/time | Get telephony attachment time settings
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment_time_settings1**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment_time_settings1) | **GET** /api/v1/reports/attachments/telephony/{id}/time | Get telephony attachment time settings
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment_visualization_settings**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment_visualization_settings) | **GET** /api/v2/reports/attachments/telephony/{id}/visualizations | Get attachment visualization settings
*ReportAttachmentsTelephonyApi* | [**get_telephony_attachment_visualization_settings1**](docs/ReportAttachmentsTelephonyApi.md#get_telephony_attachment_visualization_settings1) | **GET** /api/v1/reports/attachments/telephony/{id}/visualizations | Get attachment visualization settings
*ReportAttachmentsTelephonyApi* | [**update_telephony_attachment_aggregation**](docs/ReportAttachmentsTelephonyApi.md#update_telephony_attachment_aggregation) | **PUT** /api/v2/reports/attachments/telephony/{id}/aggregation | Update attachment aggregation
*ReportAttachmentsTelephonyApi* | [**update_telephony_attachment_aggregation1**](docs/ReportAttachmentsTelephonyApi.md#update_telephony_attachment_aggregation1) | **PUT** /api/v1/reports/attachments/telephony/{id}/aggregation | Update attachment aggregation
*ReportAttachmentsTelephonyApi* | [**update_telephony_attachment_settings**](docs/ReportAttachmentsTelephonyApi.md#update_telephony_attachment_settings) | **PUT** /api/v2/reports/attachments/telephony/{id}/settings | Update attachment settings
*ReportAttachmentsTelephonyApi* | [**update_telephony_attachment_settings1**](docs/ReportAttachmentsTelephonyApi.md#update_telephony_attachment_settings1) | **PUT** /api/v1/reports/attachments/telephony/{id}/settings | Update attachment settings
*ReportAttachmentsTelephonyApi* | [**update_telephony_attachment_time_settings**](docs/ReportAttachmentsTelephonyApi.md#update_telephony_attachment_time_settings) | **PUT** /api/v2/reports/attachments/telephony/{id}/time | Update telephony attachment time settings
*ReportAttachmentsTelephonyApi* | [**update_telephony_attachment_time_settings1**](docs/ReportAttachmentsTelephonyApi.md#update_telephony_attachment_time_settings1) | **PUT** /api/v1/reports/attachments/telephony/{id}/time | Update telephony attachment time settings
*ReportAttachmentsTelephonyApi* | [**update_telephony_attachment_visualization_settings**](docs/ReportAttachmentsTelephonyApi.md#update_telephony_attachment_visualization_settings) | **PUT** /api/v2/reports/attachments/telephony/{id}/visualizations | Update visualization settings
*ReportAttachmentsTelephonyApi* | [**update_telephony_attachment_visualization_settings1**](docs/ReportAttachmentsTelephonyApi.md#update_telephony_attachment_visualization_settings1) | **PUT** /api/v1/reports/attachments/telephony/{id}/visualizations | Update visualization settings
...
*StatusMapsApi* | [**create_connection**](docs/StatusMapsApi.md#create_connection) | **POST** /api/v1/maps/{id}/connections | Create connection
*StatusMapsApi* | [**create_connection1**](docs/StatusMapsApi.md#create_connection1) | **POST** /api/v2/maps/{id}/connections | Create connection
*StatusMapsApi* | [**create_node**](docs/StatusMapsApi.md#create_node) | **POST** /api/v1/maps/{id}/nodes | Create node
*StatusMapsApi* | [**create_node1**](docs/StatusMapsApi.md#create_node1) | **POST** /api/v2/maps/{id}/nodes | Create node
...
*StatusMapsApi* | [**delete_connection_by_id**](docs/StatusMapsApi.md#delete_connection_by_id) | **DELETE** /api/v1/maps/{id}/connections/{connectionId} | Delete connection from status map
*StatusMapsApi* | [**delete_connection_by_id1**](docs/StatusMapsApi.md#delete_connection_by_id1) | **DELETE** /api/v2/maps/{id}/connections/{connectionId} | Delete connection from status map
*StatusMapsApi* | [**delete_node_by_id**](docs/StatusMapsApi.md#delete_node_by_id) | **DELETE** /api/v1/maps/{id}/nodes/{nodeId} | Delete node from status map
*StatusMapsApi* | [**delete_node_by_id1**](docs/StatusMapsApi.md#delete_node_by_id1) | **DELETE** /api/v2/maps/{id}/nodes/{nodeId} | Delete node from status map
...
*StatusMapsApi* | [**get_connections**](docs/StatusMapsApi.md#get_connections) | **GET** /api/v1/maps/{id}/connections | Get connections by status map Id
*StatusMapsApi* | [**get_connections1**](docs/StatusMapsApi.md#get_connections1) | **GET** /api/v2/maps/{id}/connections | Get connections by status map Id
...
*StatusMapsApi* | [**get_status_map_nodes**](docs/StatusMapsApi.md#get_status_map_nodes) | **GET** /api/v1/maps/{id}/nodes | Get all nodes for a specific status map
*StatusMapsApi* | [**get_status_map_nodes1**](docs/StatusMapsApi.md#get_status_map_nodes1) | **GET** /api/v2/maps/{id}/nodes | Get all nodes for a specific status map
...
*StatusMapsApi* | [**update_connection_by_status_map_id**](docs/StatusMapsApi.md#update_connection_by_status_map_id) | **PUT** /api/v1/maps/{id}/connections/{connectionId} | Update connection
*StatusMapsApi* | [**update_connection_by_status_map_id1**](docs/StatusMapsApi.md#update_connection_by_status_map_id1) | **PUT** /api/v2/maps/{id}/connections/{connectionId} | Update connection
*StatusMapsApi* | [**update_node_by_id**](docs/StatusMapsApi.md#update_node_by_id) | **PUT** /api/v1/maps/{id}/nodes/{nodeId} | Update node
*StatusMapsApi* | [**update_node_by_id1**](docs/StatusMapsApi.md#update_node_by_id1) | **PUT** /api/v2/maps/{id}/nodes/{nodeId} | Update node
...
*TagsApi* | [**get_tags**](docs/TagsApi.md#get_tags) | **GET** /api/v2/tags/{name}/indicatortypes | Get Indicator Types Based On Tag Name 
*TagsApi* | [**get_tags1**](docs/TagsApi.md#get_tags1) | **GET** /api/v2/tags | Get all Tags
...
*UsersApi* | [**create_user_using_post**](docs/UsersApi.md#create_user_using_post) | **POST** /api/v2/users | Create user
*UsersApi* | [**delete_user_using_delete**](docs/UsersApi.md#delete_user_using_delete) | **DELETE** /api/v2/users/{id} | Delete user
...
*UsersApi* | [**partially_update_user_using_patch**](docs/UsersApi.md#partially_update_user_using_patch) | **PATCH** /api/v2/users/{id} | Update user
...
*UsersApi* | [**update_user_preferences_using_patch**](docs/UsersApi.md#update_user_preferences_using_patch) | **PATCH** /api/v2/users/mypreferences | Update user preferences
...
## Documentation For Models
 ...
 - [DeviceGroupFilter](docs/DeviceGroupFilter.md)
 ...
 - [FlowFalconDrillDownDto](docs/FlowFalconDrillDownDto.md)
 ...
 - [FlowFalconView](docs/FlowFalconView.md)
 ...
 - [IndicatorTypeRequestDto](docs/IndicatorTypeRequestDto.md)
 ...
 - [ObjectAttachmentResourceV1](docs/ObjectAttachmentResourceV1.md)
 ...
 - [ObjectTypeRequestDto](docs/ObjectTypeRequestDto.md)
 ...
 - [PagerDeviceObjectDto](docs/PagerDeviceObjectDto.md)
 ...
 - [PagerIndicatorDto](docs/PagerIndicatorDto.md)
 ...
 - [Pairlongint](docs/Pairlongint.md)
 ...
 - [TelephonyAttachmentAggregation](docs/TelephonyAttachmentAggregation.md)
 - [TelephonyAttachmentAggregationV1](docs/TelephonyAttachmentAggregationV1.md)
 - [TelephonyAttachmentRequestDto](docs/TelephonyAttachmentRequestDto.md)
 - [TelephonyAttachmentRequestDtoV1](docs/TelephonyAttachmentRequestDtoV1.md)
 - [TelephonyAttachmentResponseDto](docs/TelephonyAttachmentResponseDto.md)
 - [TelephonyAttachmentResponseDtoV1](docs/TelephonyAttachmentResponseDtoV1.md)
 - [TelephonyAttachmentSettings](docs/TelephonyAttachmentSettings.md)
 - [TelephonyAttachmentSettingsV1](docs/TelephonyAttachmentSettingsV1.md)
 - [TelephonyAttachmentVisualization](docs/TelephonyAttachmentVisualization.md)
 - [TelephonyAttachmentVisualizationV1](docs/TelephonyAttachmentVisualizationV1.md)
 - [TelephonySetting](docs/TelephonySetting.md)
