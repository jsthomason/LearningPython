...
from swagger_client.models.pairlongint import Pairlongint  # noqa: F401,E501
...
class FlowFalconColumnsSetting(object):
    ...
    """
    swagger_types = {
        'columns': 'list[Pairlongint]',
        'order': 'str',
        'sort_col': 'Pairlongint'
    }
    ...
    def __init__(self, columns=None, order=None, sort_col=None):  # noqa: E501
