...
class Severity(object):
    ...
    def __init__(self, active=None, alert_id=None, assigned=None, device_id=None, end_time=None, num_alerts=None, object_id=None, severity=None, start_time=None):  # noqa: E501
