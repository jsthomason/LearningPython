...
class TopNSettingV1(object):
    ...
    def __init__(self, capacity_threshold=None, display_only_exceeding_objects=None, display_r_values=None, object_descriptions=None, sort_by=None, sort_order=None, template_id=None):  # noqa: E501
