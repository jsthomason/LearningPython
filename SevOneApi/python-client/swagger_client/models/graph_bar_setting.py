...
class GraphBarSetting(object):
    ...
    def __init__(self, draw_graph_outline=None, pretty_x_axis=None, pretty_y_axis=None, scale_to_minimum_value=None, scaled=None, show_aggregation=None, show_average=None, show_frequency=None, show_last=None, show_legend=None, show_peak=None, show_timespan=None, show_title=None, show_valley=None):  # noqa: E501
