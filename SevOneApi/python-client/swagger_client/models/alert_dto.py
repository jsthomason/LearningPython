...
class AlertDto(object):
    ...
    def __init__(self, acknowledged_by=None, alert_flow_falcon=None, assigned_to=None, clear_message=None, closed=None, closed_key=None, comments=None, device_id=None, end_time=None, id=None, ignore_comment=None, ignore_uid=None, ignore_until=None, indicator_id=None, is_maintenance_alert=None, last_processed=None, message=None, number=None, object_id=None, origin=None, plugin_name=None, poll_id=None, severity=None, start_time=None, threshold_id=None):  # noqa: E501
