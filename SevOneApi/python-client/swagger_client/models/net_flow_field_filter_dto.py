...
class NetFlowFieldFilterDto(object):
    ...
    def __init__(self, byte_size=None, custom=None, data_units=None, database_type=None, default_aggregation=None, description=None, display_units=None, element_ids=None, field_type=None, ids=None, key=None, name=None, supported=None, synthetic=None):  # noqa: E501
