...
class NodeAlert(object):
    ...
    def __init__(self, assigned_name=None, device_id=None, device_name=None, end_time=None, id=None, message=None, occurrences=None, severity=None, start_time=None):  # noqa: E501
