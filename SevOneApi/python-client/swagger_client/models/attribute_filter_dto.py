...
class AttributeFilterDto(object):
    ...
    def __init__(self, entity_type=None, ids=None, name=None, namespace_ids=None, singleton=None, type=None, validation_expression=None):  # noqa: E501
    ...
    def type(self):
        ...
        Type can be `integer`, `string`, `ip`, `mac`, `dateTime`, `regex`, `url`, `latLong`  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: list[str]
        """
        allowed_values = ["integer", "ip", "mac", "url", "dateTime", "regex", "latLong", "string"]  # noqa: E501
