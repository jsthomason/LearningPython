...
class FlowFalconPerformanceMetricsRequestDto(object):
    ...
    def __init__(self, data_columns=None, end_time=None, filters=None, flow_falcon=None, key_fields=None, key_lines=None, resource=None, start_time=None, template=None, units=None):  # noqa: E501
