...
class TagsApi(object):
    ...
    def get_tags(self, name, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_tags(name, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_tags_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_tags_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def get_tags_with_http_info(self, name, **kwargs):  # noqa: E501
        """Get Indicator Types Based On Tag Name   # noqa: E501

        Endpoint for retrieving all Indicator Types Based On Tag Name that supports pagination  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tags_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `get_tags`")  # noqa: E501
