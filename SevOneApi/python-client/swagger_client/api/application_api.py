...
class ApplicationApi(object):
    ...
    def post_logging_level(self, logger, **kwargs):  # noqa: E501
        """Change logging level per logger  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_logging_level(logger, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param LoggingLevel logger: Requested logger with the requested level (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_logging_level_with_http_info(logger, **kwargs)  # noqa: E501
        else:
            (data) = self.post_logging_level_with_http_info(logger, **kwargs)  # noqa: E501
            return data

    def post_logging_level_with_http_info(self, logger, **kwargs):  # noqa: E501
        """Change logging level per logger  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_logging_level_with_http_info(logger, async_req=True)
        >>> result = thread.get()
        ...
        if ('logger' not in params or
            ...
            raise ValueError("Missing the required parameter `logger` when calling `post_logging_level`")  # noqa: E501
    ...
    def post_logging_level1(self, logger, **kwargs):  # noqa: E501
        """Change logging level per logger  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_logging_level1(logger, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_logging_level1_with_http_info(logger, **kwargs)  # noqa: E501
        else:
            (data) = self.post_logging_level1_with_http_info(logger, **kwargs)  # noqa: E501
            return data

    def post_logging_level1_with_http_info(self, logger, **kwargs):  # noqa: E501
        """Change logging level per logger  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_logging_level1_with_http_info(logger, async_req=True)
        >>> result = thread.get()
        ...
        if ('logger' not in params or
                params['logger'] is None):
            raise ValueError("Missing the required parameter `logger` when calling `post_logging_level1`")  # noqa: E501
