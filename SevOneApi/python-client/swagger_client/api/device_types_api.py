...
class DeviceTypesApi(object):
    ...
    def create_device_type(self, device_type_request_dto, **kwargs):  # noqa: E501
        """Create device type  # noqa: E501

        Create new device type  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_device_type(device_type_request_dto, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param DeviceTypeRequestDto device_type_request_dto: Device request object (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_device_type_with_http_info(device_type_request_dto, **kwargs)  # noqa: E501
        else:
            (data) = self.create_device_type_with_http_info(device_type_request_dto, **kwargs)  # noqa: E501
            return data

    def create_device_type_with_http_info(self, device_type_request_dto, **kwargs):  # noqa: E501
        """Create device type  # noqa: E501

        Create new device type  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_device_type_with_http_info(device_type_request_dto, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['device_type_request_dto']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'device_type_request_dto' is set
        if ('device_type_request_dto' not in params or
                params['device_type_request_dto'] is None):
            raise ValueError("Missing the required parameter `device_type_request_dto` when calling `create_device_type`")  # noqa: E501
        ...
        body_params = None
        if 'device_type_request_dto' in params:
            body_params = params['device_type_request_dto']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def create_device_type1(self, device_type_request_dto, **kwargs):  # noqa: E501
        """Create device type  # noqa: E501

        Create new device type  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_device_type1(device_type_request_dto, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_device_type1_with_http_info(device_type_request_dto, **kwargs)  # noqa: E501
        else:
            (data) = self.create_device_type1_with_http_info(device_type_request_dto, **kwargs)  # noqa: E501
            return data

    def create_device_type1_with_http_info(self, device_type_request_dto, **kwargs):  # noqa: E501
        """Create device type  # noqa: E501

        Create new device type  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_device_type1_with_http_info(device_type_request_dto, async_req=True)
        >>> result = thread.get()
        ...
        if ('device_type_request_dto' not in params or
                params['device_type_request_dto'] is None):
            raise ValueError("Missing the required parameter `device_type_request_dto` when calling `create_device_type1`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DeviceTypeResponseDto',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def filter_device_types(self, filter, **kwargs):  # noqa: E501
        """Filter devices  # noqa: E501

        Find all device types that match the criteria  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.filter_device_types(filter, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.filter_device_types_with_http_info(filter, **kwargs)  # noqa: E501
        else:
            (data) = self.filter_device_types_with_http_info(filter, **kwargs)  # noqa: E501
            return data

    def filter_device_types_with_http_info(self, filter, **kwargs):  # noqa: E501
        """Filter devices  # noqa: E501

        Find all device types that match the criteria  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.filter_device_types_with_http_info(filter, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filter', 'include_devices', 'include_object_types', 'page', 'size', 'include_count', 'sort_by', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('filter' not in params or
            ...
            raise ValueError("Missing the required parameter `filter` when calling `filter_device_types`")  # noqa: E501
    ...
    def get_ancestors_for_device_types(self, ids, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str ids: The ids of the device types (required)
        :return: list[list[DeviceTypeDto]]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_device_types(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_device_types_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_device_types_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_device_types_with_http_info(self, **kwargs):  # noqa: E501
        """Get all device types  # noqa: E501

        Endpoint for retrieving all device types that supports pagination  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_device_types_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_device_types1_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'size', 'include_count', 'sort_by', 'fields', 'include_object_types']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
